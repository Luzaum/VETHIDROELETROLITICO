...
import { SODIUM_GUIDE_CONTENT } from '../data/sodium_guide';

const SodiumGuidePage: React.FC = () => {
  return (
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Da Fisiologia à Correção na Clínica de Cães e Gatos
          </p>
        </div>
        
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <ContentRenderer content={SODIUM_GUIDE_CONTENT} />
        </div>
...
export default SodiumGuidePage;
